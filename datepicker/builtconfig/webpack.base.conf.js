...
var entries = utils.getEntry('./src/view/*/index.js'); // 获得入口js文件

// 手动配置全局公共资源，打包到vendors
entries[config.build.staticPath+ '/common/vendors'] = [
  'vue'
];
...
module.exports = {
  ...
  output: {
    ...
    filename: '[name].js',
    chunkFilename: config.build.staticPath+'/chunks/[chunkhash].js?[name]' //require.ensure异步加载的路由js单独打包
  },
  resolve: {
    extensions: ['', '.js', '.vue'],
    ...
    alias: {
      ...
      'commoncss': path.resolve(__dirname, '../src/assets/css/common.css'),
  ...
  plugins: [
    ...
    new webpack.optimize.CommonsChunkPlugin({
      name: config.build.staticPath+'/common/vendors', // 公共模块的名称
